...
namespace OtomasyonKutuphane
{
    public partial class FormEmanet : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("insert into EMANET (uyeAdi,uyeSoyadi,kitapIsmi,emanetTarihi) values (@e1,@e2,@e3,@e4)",bgl.baglanti());
            ...
            komut.Parameters.AddWithValue("@e4", maskedTextBoxAlısTarih.Text);
            komut.ExecuteNonQuery();
            

            bgl.baglanti().Close();
            MessageBox.Show("Ödünç Alma İşlemi Başarılı");
