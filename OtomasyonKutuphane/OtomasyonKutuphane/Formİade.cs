...
{
    public partial class Formİade : Form
    {
        public Formİade()
        {
            InitializeComponent();
        ...
        {
            SqlCommand komut = new SqlCommand("insert into KITAP_IADE (uyeAd,uyeSoyad,kitapAd,iadeTarih) values (@e1,@e2,@e3,@e4)", bgl.baglanti());
            ...
            komut.Parameters.AddWithValue("@e4", maskedTextBoxİadeTarih.Text);
            komut.ExecuteNonQuery();

            bgl.baglanti().Close();
            MessageBox.Show("İade Etme İşlemi Başarılı");
        ...
        private void Formİade_Load(object sender, EventArgs e)
        {
